    ...
    <footer className="bg-black text-white py-12 px-6 md:px-16 border-t border-gray-700">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div className="flex flex-col">
          <h2 className="text-2xl font-extrabold text-purple-600 mb-3">
            Abike_Chops
          </h2>
        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-wrap gap-4 mb-4">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="p-3 bg-gray-800 rounded-full hover:bg-red-600 transition-all duration-300"
            >
              <FaTiktok size={18} />
            </a>
            <a
            ...
            <a
              href="https://www.linkedin.com/in/olawepo-damilola-a5a1102b2"
              target="_blank"
              rel="noreferrer"
              className="p-3 bg-gray-800 rounded-full hover:bg-red-600 transition-all duration-300"
            >
          ...
          <p className="text-white text-sm mt-2">
            Developed by{" "}
            <span className="text-red-500 font-semibold">Damilola</span> —{" "}
            <a
      ...
      <div className="mt-12 border-t border-gray-700 pt-6 text-center text-sm text-white">
        <p>
          ...
          <span className="text-white">Abike_Chops</span>. All Rights Reserved.
        </p>
      </div>
    </footer>
  );
